          ...
          <div className="modal-body px-4 py-3">
            <div className="row g-4">
              ...
              <div className="col-md-6">
                ...
                <input className="form-control" value={produccion.EstadosPedido} disabled />
              </div>

              <div className="col-md-6">
                <label className="form-label">⏳ Estado</label>
                <input className="form-control" value={produccion.Estado} disabled />
              </div>
                ...
                {produccion.Productos.map((item, index) => (
                  <div key={index} className="row mb-2">
                    ...
                    <div className="col-md-3">
                      <input type="number" className="form-control" value={item.precio} disabled />
                    </div>
                  </div>
                ))}
              </div>
